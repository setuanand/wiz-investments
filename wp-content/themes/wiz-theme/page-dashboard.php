    ...
    <div class="dashboard-grid">
        ...
        <div class="dashboard-card">
            ...
            <ul class="dashboard-actions">
                <li><a href="<?php echo esc_url(home_url('/edit-profile/')); ?>" class="btn btn-secondary">Edit Profile</a></li>
                <li><a href="<?php echo esc_url(home_url('/change-password/')); ?>" class="btn btn-secondary">Change Password</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="dashboard-section">
        ...
        <div class="resources-grid">
            <div class="resource-card">
                ...
                <a href="<?php echo esc_url(home_url('/analytics-dashboard/')); ?>" class="btn btn-primary">Go to Analytics</a>
            </div>
